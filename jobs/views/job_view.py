...
This module defines the `JobViewSet` class, which provides CRUD operations for `Job` instances.
The `JobViewSet` class includes methods for listing, creating, retrieving, updating, and deleting 
...
- `retrieve`: Retrieves and returns a specific `Job` instance by ID with a custom response format.
...
class JobViewSet(viewsets.ModelViewSet):
    ...
    Provides methods for creating, listing, retrieving, updating, and deleting Job instances.
    """
    ...
    def create(self, request, *args, **kwargs):
        ...
        Validates the incoming data, creates a new Job instance, and returns a success response.
        """
